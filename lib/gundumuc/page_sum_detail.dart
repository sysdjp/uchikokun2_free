...
import 'package:uchikokun2_free/gundumuc/edit_screen.dart';
import 'package:uchikokun2_free/gundumuc/status_info.dart';
import 'package:uchikokun2_free/gundumuc/sum_info.dart';
            ...
            onTap: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                    ...
                    builder: (context) => EditScreen(index)),
              ).then((value) {
